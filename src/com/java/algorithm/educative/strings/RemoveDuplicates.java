...
class RemoveDuplicates {
    ...
    static void removeDuplicatesSlow(char[] str) {
    ...
    public static void main(String[] args) {
        ...
        input = getArray("dabbac");
        System.out.print("Before Slow: ");
        System.out.println(input);
        RemoveDuplicates.removeDuplicatesSlow(input);
        System.out.print("After Slow: ");
        print(input);
    }
}