...
class TripletSumClosetToTarget {
    ...
    public static void main(String[] args) {
        System.out.println(TripletSumClosetToTarget.searchTriplet(new int[] { -2, 0, 1, 2 }, 2));
        System.out.println(TripletSumClosetToTarget.searchTriplet(new int[] { -3, -1, 1, 2 }, 1));
        System.out.println(TripletSumClosetToTarget.searchTriplet(new int[] { 1, 0, 1, 1 }, 100));
    }
}